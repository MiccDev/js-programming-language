    ...
    makeTokens() {
        ...
        while(this.currentChar != null) {
            if(" \t\r".includes(this.currentChar)) {
                ...
                tokens.push(new Token(TokenTypes.NEWLINE, null, this.pos));
                this.advance();
                ...
                tokens.push(new Token(TokenTypes.LSQUARE, null, this.pos));
                this.advance();
            } else if(this.currentChar == ']') {
                tokens.push(new Token(TokenTypes.RSQUARE, null, this.pos));
                this.advance();
            } else if(this.currentChar == ',') {
                tokens.push(new Token(TokenTypes.COMMA, null, this.pos));
                this.advance();
            } else {
